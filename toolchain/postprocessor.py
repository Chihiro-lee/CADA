...
for f in sys.argv[2:]:
    ...
    while line:
        ...
        ######  BR + BRA checks #######
            ...
            if(match.group(2) != "0xfef6" and match.group(2) != "0xfefa" and match.group(2) != "0xfefe"and not checkAddress(match.group(2),bottomInstructionMemory,topInstructionMemory,20)): #BR won't allow more than 16 bits           
